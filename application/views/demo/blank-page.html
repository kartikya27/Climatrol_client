...
<head>
    ...
    <!-- Page Title -->
    <title> Blank Page - Offshore - Responsive Gas &amp; Oil Industry HTML Template </title>
        ...
        <main class="main">
            ...
            <div class="breadcrumbs">
                <div class="container">
                    ...
                    <span class="child"> Blank page </span>
                </div>
            </div>
            <!-- Breadcrumbs -->
            ...
            <section class="blank-page">
                <div class="container">
                    <div class="text-center">
                        <h1> This is a Blank Page you can add your contents here </h1>
                        <br>
                        <br>
                        <br>
                        <br>
