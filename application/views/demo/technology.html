...
<head>
    ...
    <!-- Page Title -->
    <title> Technology - Offshore - Responsive Gas &amp; Oil Industry HTML Template </title>
        ...
        <main class="main">
            ...
            <div class="breadcrumbs">
                <div class="container">
                    ...
                    <span class="child"> Technology </span>
                </div>
            </div>
            <!-- Breadcrumbs -->
            ...
            <section class="blank-page">
                <div class="container">
                    <div class="text-center">
                        <h1> This is a Technology Page you can add your contents here </h1>
                    </div>
                </div>
            </section>
            <!-- Content Section -->
