            ...
            <div id="content"><h1> Home Page About Us</h1>
...
foreach($row as $r){
           ...
           ?> 
                        ...
                        <tr> 
                        <td>
                            <img src="<?php echo base_url(); ?>images/img/<?php echo $r->img1; ?>" style="height:80px; width:80px;" /></td>
                      ...
                      <td class="text-center"><a  data-toggle="modal" data-target="#edit<?php   echo $r->id; ?>" class="btn btn-primary btn-xs"> Edit </a></td>
                        ...
                        <td class="text-center"><button class="btn btn-danger btn-xs" onclick="deleteSingle(<?php echo $r->id;?>,'aboutUs')">Delete</button></td>
                    </tr> 
...
<div class="modal fade" id="addDiscountCode" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="addAboutUs" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="update" value="">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">Add About Us</h4><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
               ...
               <div class="modal-body">
                   ...
                   <div class="form-group" style="position: relative;">
                        <label>Text</label>
                    <textarea name="text" cols="" rows="" class="form-control"></textarea>
                    </div>               
                   ...
                   <div class="form-group">
                      ...
                      <input class="form-control" name="section" value="about" type="hidden">
                    </div>
