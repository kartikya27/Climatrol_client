            ...
            <div id="content"><h1> Home Page Services</h1>
...
foreach($row as $r){
           ...
           ?> 
                        ...
                        <tr> 
                        <td><img src="<?php echo base_url(); ?>img/service/<?php echo $r->img; ?>" style="height:80px; width:80px;" /></td>
                      ...
                      <td class="text-center"><a  data-toggle="modal" data-target="#edit<?php echo $r->id;?>" class="btn btn-primary btn-xs"> Edit </a></td>
                        ...
                        <td class="text-center"><button class="btn btn-danger btn-xs" onclick="deleteSingle(<?php echo $r->id;?>,'services')">Delete</button></td>
                    </tr> 
                ...
                <form action="editService" method="POST" enctype="multipart/form-data">
                    <div class="modal-header"><h4 class="modal-title" id="myModalLabel">Edit Service Details</h4>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <label>Text</label>
                                <textarea name="text" class="form-control"  rows="7" ><?php echo $r->text; ?></textarea>
