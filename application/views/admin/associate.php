...
foreach($row as $r){
           ...
           ?> 
                        ...
                        <tr> 
                        <td><img src="<?php echo base_url();?>img/associate/<?php echo $r->icon; ?>" style="height:80px; width:80px;" /></td>
...
<div class="modal fade" id="addDiscountCode" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="addAssociate" method="POST" enctype="multipart/form-data">
                <!--<input type="hidden" name="update" value="">-->
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">Add Associate</h4><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
               ...
               <div class="modal-body">
                   ...
                   <div class="form-group">
                      ...
                      <input class="form-control"type="hidden" name="type" value="associate" type="text">
                    </div>
...
<div class="modal fade" id="edit<?php echo $r->id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
           <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="editAssociate" method="POST" enctype="multipart/form-data">
                    <div class="modal-header">
                            <h4 class="modal-title" id="myModalLabel">Edit Associate Details</h4>
                        ...
                        <!--          <div class="form-group">-->
                                <!--<label>Name</label>-->
                                <input type="hidden" name="type" class="form-control" value="<?php echo $r->type; ?>">
                            </div>
                            <div class="form-group">
                                <label>Image</label>
                                <input type="file" name="img" class="form-control" value="<?php echo $r->icon; ?>">
                                <!--<img src="./images/04/Nutritionist_images/<?php echo $r->image?>" height="100px" width="100px">-->
                            </div>
                            <!--<div class="form-group">-->
                            <!--    <label>Text</label>-->
